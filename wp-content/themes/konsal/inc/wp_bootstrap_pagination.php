...
function konsal_pagination( $args = array() ) {
    ...
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'konsal' ),
        'next_string'     => esc_html__( '&raquo;', 'konsal' ),
        'before_output'   => '',
        'after_output'    => ''
    );
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'konsal_pagination_defaults', $defaults )
    );
