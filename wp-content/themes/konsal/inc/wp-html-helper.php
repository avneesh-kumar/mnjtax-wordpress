...
// image default alt
if( !function_exists( 'konsal_img_default_alt' ) ){
	function konsal_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'konsal_img_tag' ) ){
	function konsal_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = konsal_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'konsal_anchor_tag' ) ){
	function konsal_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'konsal_heading_tag' ) ){
	function konsal_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'konsal_paragraph_tag' ) ){
	function konsal_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'konsal_span_tag' ) ){
	function konsal_span_tag( array $args ){
