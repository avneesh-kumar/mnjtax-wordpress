...
final class ReporterWordPress {
	...
	public function get_title() {
        ...
        return esc_html__( 'WordPress Environment', 'questionar-elementor' );
	...
	public function get_fields() {
		...
		return [
			'version'               => esc_html__( 'Version', 'questionar-elementor' ),
			'site_url'              => esc_html__( 'Site URL', 'questionar-elementor' ),
			'home_url'              => esc_html__( 'Home URL', 'questionar-elementor' ),
			'is_multisite'          => esc_html__( 'WP Multisite', 'questionar-elementor' ),
			'max_upload_size'       => esc_html__( 'Max Upload Size', 'questionar-elementor' ),
			'memory_limit'          => esc_html__( 'Memory limit', 'questionar-elementor' ),
			'permalink_structure'   => esc_html__( 'Permalink Structure', 'questionar-elementor' ),
			'language'              => esc_html__( 'Language', 'questionar-elementor' ),
			'timezone'              => esc_html__( 'Timezone', 'questionar-elementor' ),
			'admin_email'           => esc_html__( 'Admin Email', 'questionar-elementor' ),
			'debug_mode'            => esc_html__( 'Debug Mode', 'questionar-elementor' ),
		];
	...
	public function get_memory_limit() {
		...
		if ( $memory_limit_bytes < $min_recommended_bytes ) {
			$result['recommendation'] = esc_html__( 'We recommend setting memory to at least 64M. For more information, ask your hosting provider.', 'questionar-elementor' );
	...
	public function get_is_multisite() {
		...
		return [
			'value' => is_multisite() ? esc_html__( 'Yes', 'questionar-elementor' ) : esc_html__( 'No', 'questionar-elementor' )
		];
	...
	public function get_permalink_structure() {
		...
		if ( ! $structure ) {
			$structure = esc_html__( 'Plain', 'questionar-elementor' );
		}
	...
	public function get_debug_mode() {
		...
		return [
			'value' => WP_DEBUG ? esc_html__( 'Active', 'questionar-elementor' ) : esc_html__( 'Inactive', 'questionar-elementor' )
		];
