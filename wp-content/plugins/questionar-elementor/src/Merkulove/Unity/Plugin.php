...
final class Plugin {
    ...
    private function initialization() {
        ...
        /** Full path to main plugin file. */
        self::$plugin_file = dirname( dirname( dirname( __DIR__ ) ) ) . '/questionar-elementor.php';
        ...
        if ( in_array( self::$type, [ 'elementor', 'wpbakery' ] ) ) {
            ...
            self::$menu_bases[] = 'appearance_page_mdp_questionar_elementor_settings';
            self::$menu_bases[] = 'elementor_page_mdp_questionar_elementor_settings';
            self::$menu_bases[] = 'settings_page_mdp_questionar_elementor_settings';

        /** For general WordPress plugins. */
        } else {

            self::$menu_bases[] = 'toplevel_page_mdp_questionar_elementor_settings';
            self::$menu_bases[] = 'questionar_elementor_page_mdp_questionar_elementor_settings';
    ...
    private function add_general_tab() {
        ...
        self::$tabs['general'] = [
            ...
            'label'         => esc_html__( 'General', 'questionar-elementor' ),
            'title'         => esc_html__( 'General Settings', 'questionar-elementor' ),
            'show_title'    => true,
            'icon'          => 'tune',
            'fields'        => []
        ];
    ...
    private function add_custom_css_tab() {
        ...
        self::$tabs['custom_css'] = [
            ...
            'label'         => esc_html__( 'Custom CSS', 'questionar-elementor' ),
            'title'         => esc_html__( 'Custom CSS', 'questionar-elementor' ),
            'show_title'    => true,
            'icon'          => 'code',
            'fields'        => [
                'custom_css' => [
                    'type'              => 'css_editor',
                    'description'       => esc_html__( 'Add custom CSS here.', 'questionar-elementor' ),
    ...
    private function add_assignments_tab() {
        ...
        self::$tabs['assignments'] = [
            ...
            'label'         => esc_html__( 'Assignments', 'questionar-elementor' ),
            'title'         => esc_html__( 'Assignments Settings', 'questionar-elementor' ),
            'show_title'    => true,
            'icon'          => 'flag',
            'assignments'   => [
    ...
    private function add_activation_tab() {
        ...
        self::$tabs['activation'] = [
            ...
            'label'         => esc_html__( 'Activation', 'questionar-elementor' ),
            'title'         => esc_html__( 'Plugin Activation', 'questionar-elementor' ),
            'show_title'    => false,
            'icon'          => 'vpn_key',
            'fields'        => [
    ...
    private function add_status_tab() {
        ...
        self::$tabs['status'] = [
            ...
            'label'         => esc_html__( 'Status', 'questionar-elementor' ),
            'title'         => esc_html__( 'System Status', 'questionar-elementor' ),
            'show_title'    => true,
    ...
    private function add_updates_tab() {
        ...
        self::$tabs['updates'] = [
            ...
            'label'         => esc_html__( 'Updates', 'questionar-elementor' ),
            'title'         => esc_html__( 'Updates', 'questionar-elementor' ),
            'show_title'    => true,
            'icon'          => 'update',
            'fields'        => [
                'check_ssl' => [
    ...
    private function add_migration_tab() {
        ...
        self::$tabs['migration'] = [
            ...
            'label'         => esc_html__( 'Migration', 'questionar-elementor' ),
            'title'         => esc_html__( 'Migration Settings', 'questionar-elementor' ),
            'show_title'    => true,
            'icon'          => 'multiple_stop',
            'fields'        => [
                'delete_plugin' => [
                    'type'              => 'select',
                    'options'           => [
                        'plugin'                => esc_html__( 'Delete plugin only', 'questionar-elementor' ),
                        'plugin+settings'       => esc_html__( 'Delete plugin and settings', 'questionar-elementor' ),
                        'plugin+settings+data'  => esc_html__( 'Delete plugin, settings and data', 'questionar-elementor' ),
                    ],
                    'default'           => 'plugin',
                ]
            ]
    ...
    public static function get_plugin_file() {
        ...
        return dirname( dirname( dirname( __DIR__ ) ) ) . '/questionar-elementor.php';
