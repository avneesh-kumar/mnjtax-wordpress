...
abstract class Tab {
    ...
    protected function do_settings_base( $tab_slug = null ) {
        ...
        settings_fields( 'QuestionarElementor' . $tab_slug . 'OptionsGroup' );
        do_settings_sections( 'QuestionarElementor' . $tab_slug. 'OptionsGroup' );
    ...
    protected function add_settings_base( $tab_slug = null ) {
        ...
        /** Status Tab. */
        register_setting( 'QuestionarElementor' . $tab_slug . 'OptionsGroup', 'mdp_questionar_elementor_' . $tab_slug . '_settings' );
        add_settings_section( 'mdp_questionar_elementor_' . $tab_slug . '_page_status_section', '', null, 'QuestionarElementor' . $tab_slug . 'OptionsGroup' );
