...
final class TabActivation extends Tab {
    ...
    public function add_settings() {
        ...
        /** Activation Tab. */
        register_setting( 'QuestionarElementorActivationOptionsGroup', 'envato_purchase_code_' . EnvatoItem::get_instance()->get_id() );
        add_settings_section( 'mdp_questionar_elementor_settings_page_activation_section', '', null, 'QuestionarElementorActivationOptionsGroup' );
    ...
    public function do_settings() {
        ...
        /** Render fields. */
        settings_fields( 'QuestionarElementorActivationOptionsGroup' );
        do_settings_sections( 'QuestionarElementorActivationOptionsGroup' );
	...
	public function display_status() {
		...
		$activation_tab = admin_url( 'admin.php?page=mdp_questionar_elementor_settings&tab=activation' );
		?>

        <hr class="mdc-list-divider">
        <h6 class="mdc-list-group__subheader"><?php esc_html_e( 'CodeCanyon License', 'questionar-elementor' ); ?></h6>
		...
		<?php if ( $this->is_activated() ) : ?>
            <a class="mdc-list-item mdp-activation-status activated" href="<?php echo esc_url( $activation_tab ); ?>">
                ...
                <span class="mdc-list-item__text"><?php esc_html_e( 'Activated', 'questionar-elementor' ); ?></span>
            </a>
		<?php else : ?>
            <a class=" mdc-list-item mdp-activation-status not-activated" href="<?php echo esc_url( $activation_tab ); ?>">
                ...
                <span class="mdc-list-item__text"><?php esc_html_e( 'Not Activated', 'questionar-elementor' ); ?></span>
            </a>
		<?php endif;
	...
	public function render_subscribe() {
        ...
        <div class="mdp-subscribe-form">
            ...
            <h3><?php esc_html_e( 'Subscribe to newsletter', 'questionar-elementor' ); ?></h3>
            <p><?php esc_html_e( 'Sign up for the newsletter to be the first to know about news and discounts.', 'questionar-elementor' ); ?></p>
            <p class="mdp-subscribe-form-message"
               data-success="<?php esc_html_e( 'Hurray! We received your Subscription request. Check your inbox for an email from us.', 'questionar-elementor' ); ?>"
               data-warn="<?php esc_html_e( 'Oh! Sorry, but we cannot send messages to this email.', 'questionar-elementor' ); ?>"
               data-error="<?php esc_html_e( 'Oops! Something went wrong. Please try later.', 'questionar-elementor' ); ?>"
            ></p>
            ...
            UI::get_instance()->render_input(
                '',
                esc_html__( 'Your Name', 'questionar-elementor' ),
                '',
                [
            ...
            UI::get_instance()->render_input(
                '',
                esc_html__( 'Your E-Mail', 'questionar-elementor' ),
                '',
                [
            ...
            UI::get_instance()->render_button(
                esc_html__( 'Subscribe', 'questionar-elementor' ),
                '',
                false,
                [
                    "name"  => "mdp-subscribe",
	...
	public function render_form() {
        ...
        <div class="mdp-activation-form">
            <h3><?php esc_html_e( 'Plugin Activation', 'questionar-elementor' ); ?></h3>
            <?php

            /** Render input. */
            UI::get_instance()->render_input(
                $purchase_code,
                esc_html__( 'Purchase code', 'questionar-elementor'),
                esc_html__( 'Enter your CodeCanyon purchase code. Allowed only one Purchase Code per website.', 'questionar-elementor' ),
                [
    ...
    public function render_FAQ() {
        ...
        <div class="mdp-activation-faq">
            <div class="mdc-accordion" data-mdp-accordion="showfirst: true">
                ...
                <h3><?php esc_html_e( 'Activation FAQ\'S', 'questionar-elementor' ); ?></h3>

                <div class="mdc-accordion-title">
                    <i class="material-icons">help</i>
                    <span class="mdc-list-item__text"><?php esc_html_e( 'Where is my Purchase Code?', 'questionar-elementor' ); ?></span>
                </div>
                <div class="mdc-accordion-content">
                    <p><?php esc_html_e( 'The purchase code is a unique combination of characters that confirms that you bought the plugin. You can find your purchase code in ', 'questionar-elementor' ); ?>
                        <a href="https://1.envato.market/cc-downloads" target="_blank"><?php esc_html_e( 'your account', 'questionar-elementor' );?></a>
                        <?php esc_html_e( ' on the CodeCanyon. Learn more about ', 'questionar-elementor' ); ?>
                        <a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank"><?php esc_html_e( 'How to find your purchase code', 'questionar-elementor' );?></a>
                        <?php esc_html_e( ' .', 'questionar-elementor');?>
                    </p>
                </div>

                <div class="mdc-accordion-title">
                    <i class="material-icons">help</i>
                    <span class="mdc-list-item__text"><?php esc_html_e( 'Can I use one Purchase Code on multiple sites?', 'questionar-elementor' ); ?></span>
                </div>
                <div class="mdc-accordion-content">
                    <p>
                        <?php esc_html_e( 'No, this is prohibited by license terms. You can use the purchase code on only one website at a time. Learn more about ', 'questionar-elementor' ); ?>
                        <a href="https://1.envato.market/KYbje" target="_blank"><?php esc_html_e( 'Envato License', 'questionar-elementor' );?></a>
                        <?php esc_html_e( ' terms. ', 'questionar-elementor' ); ?>
                    </p>
                </div>

                <div class="mdc-accordion-title">
                    <i class="material-icons">help</i>
                    <span class="mdc-list-item__text"><?php esc_html_e( 'What are the benefits of plugin activation?', 'questionar-elementor' ); ?></span>
                </div>
                <div class="mdc-accordion-content">
                    <p>
                        <?php esc_html_e( 'Activation of the plugin allows you to use all the functionality of the plugin on your site. In addition, in some cases, activating the plugin allows you to access additional features and capabilities of the plugin. Also, using an authored version of the plugin, you can be sure that you will not violate the license.', 'questionar-elementor' ); ?>
                    </p>
                </div>

                <div class="mdc-accordion-title">
                    <i class="material-icons">help</i>
                    <span class="mdc-list-item__text"><?php esc_html_e( 'What should I do if my Purchase Code does not work?', 'questionar-elementor' ); ?></span>
                </div>
                <div class="mdc-accordion-content">
                    <p>
                        <?php esc_html_e( 'There are several reasons why the purchase code may not work on your site. Learn more why your ', 'questionar-elementor' ); ?>
                        <a href="https://merkulove.zendesk.com/hc/en-us/articles/360006100998-Troubleshooting-of-the-plugin-activation" target="_blank"><?php esc_html_e( 'Purchase Code is Not Working', 'questionar-elementor' );?></a>
                        <?php esc_html_e( ' .', 'questionar-elementor');?>
                    </p>
                </div>
