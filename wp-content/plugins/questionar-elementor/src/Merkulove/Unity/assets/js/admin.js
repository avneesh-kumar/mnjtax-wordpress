...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        let mdpQuestionarElementor = window.mdpQuestionarElementorUnity;
        ...
        $subscribeBtn.on( 'click', function (e) {
            ...
            if ( $mail.val().length > 0 && window.MerkulovMaterial[mailIndex].valid) {
                ...
                $.ajax({
                    type: "GET",
                    url: `${ mdpQuestionarElementor.restBase }questionar-elementor/v2/subscribe`,
                    crossDomain: true,
        ...
        $checkUpdatesBtn.on( 'click', function ( e ) {
            ...
            let data = {
                action: 'check_updates_questionar_elementor',
                nonce: mdpQuestionarElementor.nonce,
                checkUpdates: true
            };

            /** Do AJAX request. */
            $.post( mdpQuestionarElementor.ajaxURL, data, function( response ) {
