...
use Merkulove\QuestionarElementor\Unity\Cache;
use Merkulove\QuestionarElementor\Unity\Helper;
use Merkulove\QuestionarElementor\Unity\Plugin;
use Merkulove\QuestionarElementor\UninstallHelper;
use Merkulove\QuestionarElementor\Unity\EnvatoItem;
...
final class Uninstall {
    ...
    private function remove_settings() {
        ...
        foreach ( wp_load_alloptions() as $option => $value ) {
            if ( strpos( $option, 'mdp_questionar_elementor' ) === 0 ) {
                $settings[] = $option;
            }
        }
    ...
    public function get_uninstall_mode() {
        ...
        if ( isset( $uninstall_settings[ 'mdp_questionar_elementor_migration_settings' ] ) && $uninstall_settings[ 'mdp_questionar_elementor_migration_settings' ] ) { // Default value.
            $uninstall_settings = [
