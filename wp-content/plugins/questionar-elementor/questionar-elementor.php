 ...
 *
 * @wordpress-plugin
 * Plugin Name: Questionar for Elementor
 * Plugin URI: https://1.envato.market/questionar-elementor
 * Description: Beautiful Frequently Asked Questions element with rich snippets for Elementor
 * Version: 1.1.6
 ...
 * Text Domain: questionar-elementor
...
use Merkulove\QuestionarElementor\Caster;
use Merkulove\QuestionarElementor\Config;
use Merkulove\QuestionarElementor\Unity\Unity;
 ...
 *
 **/
final class QuestionarElementor {

    /**
     * The one true QuestionarElementor.
     *
     * @var QuestionarElementor
     * @since 1.0.0
     * @access private
     **/
	...
	public static function on_activation() {
        ...
        /** Call Questionar on plugin activation */
...
register_activation_hook( __FILE__, [ QuestionarElementor::class, 'on_activation' ] );

/** Run 'on_deactivation' when the plugin is deactivated. */
register_deactivation_hook( __FILE__, [ QuestionarElementor::class, 'on_deactivation' ] );

/** Run Plugin class once after activated plugins have loaded. */
add_action( 'plugins_loaded', [ QuestionarElementor::get_instance(), 'setup' ] );
